...
//RSAPrivateKey rsaPrivateKey1 = RSAPrivateKey()
    ...
    public static String createJWTNewOneObjects(String issuerId, String classSuffix, String objectSuffix) throws NoSuchAlgorithmException, InvalidKeySpecException, IOException {
        // See link below for more information on required properties
        // https://developers.google.com/wallet/generic/rest/v1/genericclass
        GenericClass newClass = new GenericClass().setId(String.format("%s.%s", issuerId, classSuffix));
...
//                        .setBarcode(new Barcode().setType("QR_CODE").setValue("QR code value"))
                        ...
                        .setLogo(
                                new Image()
                                        .setSourceUri(
                                                new ImageUri()
                                                        .setUri(
                                                                "https://raw.githubusercontent.com/droidbg/assets/main/under_ocean.png"))
                                        .setContentDescription(
                                                new LocalizedString()
                                                        .setDefaultValue(
                                                                new TranslatedString()
        ...
        claims.put("iss", "abcd-654@abcd-416109.iam.gserviceaccount.com");
